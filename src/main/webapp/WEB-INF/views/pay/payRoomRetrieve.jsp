    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $(document).on("click", ".btn-member-delete", function(){
                ...
                memberNameArr.splice(index,1); // memberNameArr 에서 member 삭제
                $(this).parent().remove(); // html에서 해당 member span 태그 삭제
                console.log("[END] index:", index, ", memberNameArr:", memberNameArr);
            });
        });
        ...
        function memberList(){
            ...
            if (member.length > 0){
                memberNameArr.push(member);
                console.log($("#member-list-tmpl").tmpl({mList:memberNameArr}));
                $("#memberList").html($("#member-list-tmpl").tmpl({mList:memberNameArr}));
            }
            $("#groupMember").val("");
        }
